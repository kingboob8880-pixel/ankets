...
(function (global) {
  const UI = {
    ru: {
      ...
      downloadFail: 'Не удалось начать скачивание. Выделите JSON выше и сохраните вручную.',
    ...
    uz: {
      ...
      downloadFail: 'Yuklab olish ishga tushmadi. JSON ni yuqoridan tanlab qo‘lda saqlang.',
